...
Total property sales value(Revenue)
Sales conversion rate
Average selling price per year, and Many More
...
-High-Value Sales Cycle: High-value assets require approximately 4 months (114.91 days) to finalize, which may impact short-term liquidity.  

-Regional Inconsistency: Significant disparities exist in average selling times by location, ranging from only 0.8 months in Calabar to 6.5 months in Lagos.  

-Concentrated Financial Risk: A large portion of projected revenue at risk is concentrated in just a few locations (Lagos, Port Harcourt, and Abuja), making the company's overall performance highly sensitive to these specific markets.
